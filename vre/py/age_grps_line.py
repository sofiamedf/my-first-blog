...
fig = px.line(df,  x=df["year"], y=["age_0_4", "age_5_9", "age_10_14", "age_15_19", "age_20_29", "age_30_39", "age_40_49",
					"age_50_59", "age_60_69", "age_70_79", "age_80_up"], color_discrete_sequence=px.colors.qualitative.Light24)
